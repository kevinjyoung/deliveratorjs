(function(){
  ...
  //_renderRestaurantsSimple = function( res, template, extra, address, menuUri, deliveryTime ) {
    var templateData = {
      address : JSON.stringify( params.address ),
      deliveryTime : params.deliveryTime,
      menu_uri : params.menuUri
  ...
  _getDefaultConfirmMiddleware = function( template, render_server, extra ) {
    ...
    return function html_default_confirm_middleware(req, res){
      ...
      //self.renderConfirmSimple(res, rid, template, extra, address, deliveryTime, tray, tip);
    };
  };
