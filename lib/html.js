(function(){
  ...
  function Html(path, ordrinApi){
    ...
    this.getAddressHead = function( rid, address, dateTime, confirmUrl, isMobile, noAngular, affSplashCss ){
      ...
      return addressHeadTemplate({path:path, rid:rid, address:address, render:true, deliveryTime: dateTime, confirmUrl:confirmUrl, isMobile : isMobile, noAngular: noAngular, affSplashCss : affSplashCss });
    };
