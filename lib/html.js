(function(){
  ...
  // DATA PARAMS
  // details, data, rid, address, render, deliveryTime, confirmUrl, head_init, isMobile, extraCss, suppressMustard
  _getHead = function get_head( data ) {
    return this.getAnyHead( 'head', data );
  };

  // DATA PARAMS
  // rid, address, deliveryTime, confirmUrl, isMobile, extraCss, suppressMustard
  ...
  // DATA PARAMS
  // isMobile, extraCss, suppressMustard
  ...
  // DATA PARAMS
  // data, address, deliveryTime, menu_uri, render, head_init, isMobile, extraCss, suppressMustard
  ...
  _render = function ( res, params, cb ) {
    ...
    this.getData( params.rid, function(err, data) {
      if(err){
        ...
        var suppressMustard = params.extra.suppressMustard ? params.extra.suppressMustard : false;
        ...
        var templateData = {
          ...
          isMobile        : isMobile,
          extraCss        : extraCss,
          suppressMustard : suppressMustard
        };
