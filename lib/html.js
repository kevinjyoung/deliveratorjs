(function(){
  ...
  function Html(path, ordrinApi){
    ...
    this.getHead = function(rid, data, address, render, dateTime, confirmUrl){
      ...
      var hash = {path:path, details:JSON.stringify(data.details), data:JSON.stringify(data.menu), rid:rid, address:address, render:render, deliveryTime: dateTime, confirmUrl:confirmUrl, head_init:data.head_init};
