(function(){
  ...
  var paths = {
    ...
    restaurants     : __dirname + "/../node_modules/mustard/restaurants.html.mustache",
    confirm         : __dirname + "/../node_modules/mustard/cofirm.html.mustache"
  },
  ...
  function Html(path, ordrinApi){
    ...
    var addressHeadPath = __dirname + "/../templates/address_head.html.mustache";
    var addressHeadTemplate = handlebars.compile(fs.readFileSync(addressHeadPath, "utf8"));
