(function(){
  ...
  /*
    this.getHead = function(rid, data, address, render, dateTime, confirmUrl, isMobile, affLogo, affTyHtml ){
      if(isString(dateTime)){
        dateTime = '"'+dateTime+'"';
      }
      var hash = {path:path, details:JSON.stringify(data.details), data:JSON.stringify(data.menu), rid:rid, address:address, render:render, deliveryTime: dateTime, confirmUrl:confirmUrl, head_init:data.head_init, isMobile : isMobile, affLogo : affLogo, affTyHtml : affTyHtml };
      return templates.head(hash);
    };
    */

    this.getSimpleHead = function( rid, address, dateTime, confirmUrl, isMobile, noAngular ){
      if(isString(dateTime)){
        dateTime = '"'+dateTime+'"';
      }
      return templates.head({path:path, rid:rid, address:address, render:true, deliveryTime: dateTime, confirmUrl:confirmUrl, isMobile : isMobile, noAngular: noAngular });
    };

    this.getAddressHead = function( rid, address, dateTime, confirmUrl, isMobile, noAngular, affSplashCss ){
      if(isString(dateTime)){
        dateTime = '"'+dateTime+'"';
      }
      return templates.addressHead({path:path, rid:rid, address:address, render:true, deliveryTime: dateTime, confirmUrl:confirmUrl, isMobile : isMobile, noAngular: noAngular, affSplashCss : affSplashCss });
    };
    ...
    this.getRestaurantsHead = function( address, menuUri, dateTime, render, data, isMobile, additQs, affRestCss ){
      if(isString(dateTime)){
        dateTime = '"'+dateTime+'"';
      }
      var hash = {path:path, data:JSON.stringify(data.restaurants), address:address, dateTime:dateTime, menu_uri:menuUri, render:render, isMobile : isMobile, additQs : additQs, affRestCss : affRestCss };
    ...
    this.getSimpleRestaurantsHead = function(address, menuUri, dateTime){
      ...
      return templates.restaurantsHead({path:path, address:address, dateTime:dateTime, menu_uri:menuUri, render:true});
    };
    ...
    this.getConfirmHead = function(rid, address, dateTime, tray, tip, render, data){
      ...
      return templates.confirmHead({path:path, rid:rid, data:JSON.stringify(data.restaurants), address:address, deliveryTime:dateTime, tray:tray, tip:tip, render:render});
    };
    ...
    this.getSimpleConfirmHead = function(rid, address, dateTime, tray, tip){
      ...
      return templates.confirmHead({path:path, rid:rid, address:address, deliveryTime:dateTime, tray:tray, tip:tip, render:true});
    };
      ...
      return function html_render(res, rid, template, extra, renderMenu, address, deliveryTime, confirmUrl, cb ){
        htmlObject.getData(rid, function(err, data){
          if(err){
            ...
            extra.head = htmlObject.getHead( rid, data, JSON.stringify(address), !renderMenu, deliveryTime, confirmUrl, isMobile, affLogo, affTyHtml );
    ...
    var getRenderRestaurants = function(htmlObject){
      return function html_restaurants_render( res, template, extra, address, menuUri, dateTime, renderList, filterRestaurants, additQs, cb ){
  ...
  getHead = function get_head( rid, data, address, render, dateTime, confirmUrl, isMobile, affLogo, affTyHtml ) {
    if(isString(dateTime)){
      dateTime = '"'+dateTime+'"';
    }
  ...
  _methods = {
    getHead : getHead /*,
    getSimpleHead : getSimpleHead,
    getAddressHead : getAddressHead,
    getRestaurantsHead : getRestaurantsHead,
    getSimpleRestaurantsHead : getSimpleRestaurantsHead,
    getConfirmHead : getConfirmHead,
    getSimpleConfirmHead : getSimpleConfirmHead,
    getMenu : getMenu,
    getRestaurants : getRestaurants,
    getData : getData,
    getRestaurantList : getRestaurantList,
    getAddHtml : getAddHtml,
    render : getRender,
    renderRestaurants : getRenderRestaurants,
    renderSimple : getRenderSimple,
    renderAddress : getRenderAddress,
    renderRestaurantsSimple : getRenderRestaurantsSimple,
    renderConfirmSimple : getRenderConfirmSimple,
    getDefaultConfirmMiddleware : getDefaultConfirmMiddleware,
    getDefaultRestaurantListMiddleware : getDefaultRestaurantListMiddleware
    */
  };

  Html.prototype = _.extend( _methods );
